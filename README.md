...
**What you get:** **47** curated projects across **7** categories, with roughly **1.9K** combined GitHub stars. Rankings use an automated **quality score** built from GitHub activity, package-manager stats, and other public signals (see the [best-of generator](https://github.com/best-of-lists/best-of-generator) ecosystem for details).
...
- [Bots & Frameworks](#bots--frameworks) _1 projects_
- [Libraries & API](#libraries--api) _6 projects_
